...
(function (global, factory) {
    ...
    switch (topLevelType) {
      ...
      case TOP_GOT_POINTER_CAPTURE: {
        ...
        queuedPointerCaptures.set(
          _pointerId2,
          accumulateOrCreateContinuousQueuedReplayableEvent(queuedPointerCaptures.get(_pointerId2) || null, blockedOn, topLevelType, eventSystemFlags, container, _pointerEvent),
        );
        return true;
      }
    }
...

    {
      if (workInProgress._debugNeedsRemount && current !== null) {
        ...
        return remountFiber(
          current,
          workInProgress,
          createFiberFromTypeAndProps(workInProgress.type, workInProgress.key, workInProgress.pendingProps, workInProgress._debugOwner || null, workInProgress.mode, workInProgress.expirationTime),
        );
      }
    }
      ...
      switch (workInProgress.tag) {
        ...
        case ClassComponent:
          ...
          if (
            ...
            (typeof ctor.getDerivedStateFromError === "function" || (instance !== null && typeof instance.componentDidCatch === "function" && !isAlreadyFailedLegacyErrorBoundary(instance)))
          ) {
            workInProgress.effectTag |= ShouldCapture;
  ...
  function pingSuspendedRoot(root, thenable, suspendedTime) {
    ...
    if (workInProgressRoot === root && renderExpirationTime$1 === suspendedTime) {
      ...
      if (
        workInProgressRootExitStatus === RootSuspendedWithDelay ||
        (workInProgressRootExitStatus === RootSuspended && workInProgressRootLatestProcessedExpirationTime === Sync && now() - globalMostRecentFallbackTime < FALLBACK_THROTTLE_MS)
      ) {
